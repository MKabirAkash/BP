        ...
        <div className="container mx-auto">
          <div className="-mx-4 flex">
            <div className="w-full px-4">
              <div className="bg-primary relative z-10 mx-auto max-w-[570px] rounded-[20px] px-10 py-16 text-center sm:px-16 md:py-24">
                ...
                <Link
                  to="/"
                  className="text-primary inline-block rounded-lg border border-white bg-white px-8 py-3 text-center text-base font-semibold transition hover:bg-opacity-90"
                >
                  Go to Home
                </Link>
